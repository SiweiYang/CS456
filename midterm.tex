...
\vfill
\part[2] What is meant when the control signalling of FTP is characterized as "out of band"?
\vfill
\end{parts}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
...
\vspace{2.5in}
\part[4] Describe how cookies can be used by a web server to maintain a user profile.
\vspace{2.5in}
